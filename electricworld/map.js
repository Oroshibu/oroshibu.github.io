$(document).ready(function(){
	...
	img["2"].src = "images/arrowr.png";
	img["3"].src = "images/arrowu.png";
	img["4"].src = "images/arrowl.png";
	img["5"].src = "images/arrowd.png";
	img["6"].src = "images/semi.png";
  ...
  img["flag"] = new Image();
	img["wire"] = new Image();
	img["inswire"] = new Image();
	img["2xgenerator"] = new Image();
	img["2xbattery"] = new Image();
	img["robot"] = new Image();
	img["robot2"] = new Image();
	img["2xmagnetr"] = new Image();
	img["2xmagnetl"] = new Image();
  ...
  img["wire"].src = "images/wire.png";
  img["inswire"].src = "images/inswire.png";
  img["2xgenerator"].src = "images/2xgenerator.png";
	img["2xbattery"].src = "images/2xbattery.png";
  img["robot"].src = "images/robot.png";
	img["robot2"].src = "images/robot2.png";
	img["2xmagnetr"].src = "images/2xmagnetr.png";
	img["2xmagnetl"].src = "images/2xmagnetl.png";
